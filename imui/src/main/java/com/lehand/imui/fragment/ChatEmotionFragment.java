...
import com.lehand.imui.adapter.EmotionGridViewAdapter;
import com.lehand.imui.adapter.EmotionPagerAdapter;
import com.lehand.imui.util.EmotionUtils;
import com.lehand.imui.util.GlobalOnItemClickManagerUtils;
import com.lehand.imui.util.ScreenUtil;
import com.lehand.imui.util.Utils;
import com.lehand.imui.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    protected void initView() {
        fragmentChatVp = mRootView.findViewById(R.id.fragment_chat_vp);
        fragmentChatGroup = mRootView.findViewById(R.id.fragment_chat_group);
    }
