...
import com.lehand.tools.overscroll.adapters.IOverScrollDecoratorAdapter;

import static com.lehand.tools.overscroll.IOverScrollState.STATE_BOUNCE_BACK;
import static com.lehand.tools.overscroll.IOverScrollState.STATE_DRAG_END_SIDE;
import static com.lehand.tools.overscroll.IOverScrollState.STATE_DRAG_START_SIDE;
import static com.lehand.tools.overscroll.IOverScrollState.STATE_IDLE;
...
public abstract class OverScrollBounceEffectDecoratorBase implements IOverScrollDecor, View.OnTouchListener {
    ...
    /**
     * 移动拖拽比率，比率越大，阻尼系数越高，滑动越吃力
     */
    public static final float DEFAULT_TOUCH_DRAG_MOVE_RATIO_FWD = 1f;
    /**
     * 移动拖拽返回比率,比率越大，阻尼系数越高，拖拽滑动越吃力（越慢）
     */
    public static final float DEFAULT_TOUCH_DRAG_MOVE_RATIO_BCK = 1f;
    /**
     * 减速系数，绝对值越大，阻尼系数越高，滑动越慢
     */
    public static final float DEFAULT_DECELERATE_FACTOR = -3f;
    /**
     * 最大反弹持续时间
     */
